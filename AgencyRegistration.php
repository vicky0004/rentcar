...
<body>
    ...
    <div class="bardbox d-flex justify-content-center" style="height:90vh;">
        <div class="card my-auto shadow login-card">
            ...
            <div class="card-body">
                <form id="login-form" action="./Backend/agencyregister.php" method="post">
                    <div class="form-group">
                        <label for="Agencyname">Agency Name</label>
                        <input type="text" id="Agencyname" class="form-control" name="Agencyname" required />
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                    <button type="submit" class="btn w-100 text-white page-btn" >Register</button>
                </form>
            </div>
